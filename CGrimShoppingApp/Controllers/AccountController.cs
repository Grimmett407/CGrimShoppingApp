...
namespace CGrimShoppingApp.Controllers
{
    ...
    public class AccountController : Universal
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model)     //Looks at RegisterVeiwModel to make sure required info is there
        {
            if (ModelState.IsValid)
            {                                                              //Creates New User using required fields
